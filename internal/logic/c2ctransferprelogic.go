...
type C2cTransferPreLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewC2cTransferPreLogic(ctx context.Context, svcCtx *svc.ServiceContext) *C2cTransferPreLogic {
	return &C2cTransferPreLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *C2cTransferPreLogic) C2CTransferPre(in *trade_itg_pb.C2CTransferPreReq) (*trade_itg_pb.C2CTransferPreRsp, error) {
	...
	return &trade_itg_pb.C2CTransferPreRsp{
		BuyerUserId:   buyerRelationRsp.UserId,
